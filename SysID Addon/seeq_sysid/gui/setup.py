...
class Setup(v.Card):  
    ...
    def __init__(self):
        ...
        self.style_ = 'width:100%; min-height:600px; height:100%; background-color:#1D376C'
        ...
        self.select_card = v.Card(children=[self.mv_title, self.mv_select, self.cv_title, self.cv_select], class_='ma-2 pa-2 justify-center', style_='width:98%', flat=True, elevation=0)
    ...
    def set_data(self, signals: list=[]):
